...
extern int		 gear_rarity(int id);
extern int		 gear_type(int id);
extern int		 gear_attribute(int id);
...
enum gear_rarity { RAR_TRASH = 0, RAR_COMMON, RAR_UNCOMMON, RAR_RARE, RAR_RAREPLUS, RAR_UNIQUE };
enum gear_type { GEAR_WEAPON, GEAR_ARMOR, GEAR_ACCESSORY, GEAR_SKILL, GEAR_ITEM, GEAR_ANY, GEAR_TRASH, GEAR_NULL };
enum gear_attribute { ATTR_NONE = 0, ATTR_FIRE, ATTR_BOLT, ATTR_ICE, ATTR_HEAL, ATTR_ATK };
